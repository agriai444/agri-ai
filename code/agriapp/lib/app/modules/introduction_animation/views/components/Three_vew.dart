...
class ThreeView extends StatelessWidget {
  ...
  const ThreeView({Key? key, required this.animationController})
      : super(key: key);
              ...
              SlideTransition(
                ...
                child: SlideTransition(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      "Based on the information provided, here's a comprehensive report on your plant's health condition.",
