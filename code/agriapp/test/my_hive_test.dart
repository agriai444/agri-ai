...
import 'package:agri_ai/app/data/models/user_model.dart';
...
main() async {
  ...
  group('hive save, read, and delete test', () {
    test('write on hive', () async {
      // save user
      bool saved = await MyHive.saveUserToHive(User.fromData(age: 23, phoneNumber: '+972595195630', username: 'Emad Beltaje'));
      expect(saved, true);
    });

    test('read from hive', () async {
      // get user and test if saving worked fine
      User? user = MyHive.getCurrentUser();
    ...
    test('delete from hive', () async {
      ...
      User? userAfterDelete = MyHive.getCurrentUser();
